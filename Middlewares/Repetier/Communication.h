...
//#if NONLINEAR_SYSTEM
FSTRINGVAR(tInvalidDeltaCoordinate_tuga)
FSTRINGVAR(tInvalidDeltaCoordinate_delta)
FSTRINGVAR(tInvalidDeltaCoordinate)
FSTRINGVAR(tDBGDeltaNoMoveinDSegment_tuga)
FSTRINGVAR(tDBGDeltaNoMoveinDSegment_delta)
...
FSTRINGVAR(tEPRDeltaMaxRadius_delta)
//#endif // DRIVE_SYSTEM
//#if DRIVE_SYSTEM==TUGA
FSTRINGVAR(tEPRDiagonalRodLength_tuga)
//#endif
#ifdef DEBUG_GENERIC
FSTRINGVAR(tGenTemp)
...
FSTRINGVAR(tEPRZAcceleration_delta)
FSTRINGVAR(tEPRZAcceleration)
FSTRINGVAR(tEPRZTravelAcceleration_delta)
FSTRINGVAR(tEPRZTravelAcceleration)
FSTRINGVAR(tEPRAccelerationFactorAtTop)
FSTRINGVAR(tEPRZStepsPerMM_delta)
FSTRINGVAR(tEPRZStepsPerMM)
FSTRINGVAR(tEPRZMaxFeedrate_delta)
FSTRINGVAR(tEPRZMaxFeedrate)
FSTRINGVAR(tEPRZHomingFeedrate_delta)
...
//#else
FSTRINGVAR(tEPRDiagonalRodLength_delta)
FSTRINGVAR(tEPRHorizontalRadius_delta)
FSTRINGVAR(tEPRTowerXOffset_delta)
FSTRINGVAR(tEPRTowerYOffset_delta)
FSTRINGVAR(tEPRTowerZOffset_delta)
//#endif
