...
#endif
#define NUM_TEMPERATURE_LOOPS 8//THERMO_CONTROLLER_INDEX+1
...
extern TemperatureController *tempController[8];
#endif
extern uint8_t autotuneIndex;
extern void analog_inputs_initial();
extern void Extruder_initArray();
