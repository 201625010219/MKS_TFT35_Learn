...
#define RFSERIAL Serial	//skyblue 2016-12-13
#include "pins.h"
...
//#define DRIVE_SYSTEM 100        //full cartesian system
//#define DRIVE_SYSTEM DELTA      //Delta printers 
...
#define PULLEY_TEETH 16//*20 //delta 1
...
//#define XAXIS_STEPS_PER_MM 78.7402//80//
/** \brief Number of steps for a 1mm move in y direction.
For xy gantry use 2*belt moved!
Overridden if EEPROM activated.*/
//#define YAXIS_STEPS_PER_MM 78.7402//80//
/** \brief Number of steps for a 1mm move in z direction  Overridden if EEPROM activated.*/
//#define ZAXIS_STEPS_PER_MM 400//80//*
#endif
#endif
// ##########################################################################################
...
// then PWM.
#define PDM_FOR_EXTRUDER 0//*1
#define PDM_FOR_COOLER 0//*1
...
// sensor as defect.
#define DECOUPLING_TEST_MAX_HOLD_VARIANCE 50//20//*15
...
#define DECOUPLING_TEST_MIN_TEMP_RISE 0.3//0.5
...
//#define EXT0_STEPS_PER_MM 90//*370//*106 //425 // 825.698 //457 
...
*/
#define EXT0_PID_I   2//0.88
/** Dgain.  Overridden if EEPROM activated.*/
#define EXT0_PID_D 40//80
...
#define EXT0_DECOUPLE_TEST_PERIOD 22000//12000
...
#define EXT2_SELECT_COMMANDS "M117 Extruder 2"
#define EXT2_DESELECT_COMMANDS ""
#define EXT3_SELECT_COMMANDS "M117 Extruder 2"
#define EXT3_DESELECT_COMMANDS ""
#define EXT4_SELECT_COMMANDS "M117 Extruder 2"
#define EXT4_DESELECT_COMMANDS ""
#define EXT5_SELECT_COMMANDS "M117 Extruder 2"
...
#define HEATER_PWM_SPEED 0//*1 // How fast ist pwm signal 0 = 15.25Hz, 1 = 30.51Hz, 2 = 61.03Hz, 3 = 122.06Hz
...
//#define HAVE_HEATED_BED true//false
...
3 = dead time control
*/
#define HEATED_BED_HEAT_MANAGER 0//*1
/** \brief The maximum value, I-gain can contribute to the output.
The precise values may differ for different nozzle/resistor combination.
 Overridden if EEPROM activated.
*/
...
//#define min_software_endstop_x false     //true	//delta 3
...
//#define ENDSTOP_X_BACK_MOVE 1		//5	//modify 8
//#define ENDSTOP_Y_BACK_MOVE 1		//5	//modify 9
//#define ENDSTOP_Z_BACK_MOVE 1		// 2//modify 10
...
#define max_software_endstop_z true    //false
#else
#define min_software_endstop_x true	//delta 3
...
#define ENDSTOP_Z_BACK_MOVE 2//5	delta 4
...
#define ENDSTOP_X_BACK_ON_HOME 1//5.0	delta 5
#define ENDSTOP_Y_BACK_ON_HOME 1//5.0
#define ENDSTOP_Z_BACK_ON_HOME 0//5.0
...
//#define Y_MAX_LENGTH 115
//#define Z_MAX_LENGTH 299.5//585.16 delta 6

//#define X_MIN_POS -115	//delta 7
//#define Y_MIN_POS -115
//#define Z_MIN_POS 0
#else
//#define X_MAX_LENGTH 200
//#define Y_MAX_LENGTH 200
//#define Z_MAX_LENGTH 120//585.16 delta 6
// Coordinates for the minimum axis. Can also be negative if you want to have the bed start at 0 and the printer can go to the left side
// of the bed. Maximum coordinate is given by adding the above X_MAX_LENGTH values.
//#define X_MIN_POS 0//-115	delta 7
//#define Y_MIN_POS 0//-115
//#define Z_MIN_POS 0
#endif
// ##########################################################################################
// ##                           Movement settings                                          ##
...
*/										//delta 8
#define DELTA_SEGMENTS_PER_SECOND_PRINT 180//600 // Move accurate setting for print moves
#define DELTA_SEGMENTS_PER_SECOND_MOVE 70//600 // Less accurate setting for other moves
...
*/
#define DELTA_DIAGONAL_ROD 297	//345 // mm	delta 9
...
//#define DELTA_MAX_RADIUS 115//*200
...
*/
#define PRINTER_RADIUS 182//*115//	265.25	//delta 10
...
#define DELTA_DIAGONAL_ROD 297	//240	//delta 11
#endif
...
//#define HOMING_FEEDRATE_Z 40	//3		//delta 12
#else
//#define HOMING_FEEDRATE_X 80
//#define HOMING_FEEDRATE_Y 80
//#define HOMING_FEEDRATE_Z 3	//3		
#endif
...
#define ZHOME_X_POS 999999//*IGNORE_COORDINATE
#define ZHOME_Y_POS 999999//*IGNORE_COORDINATE
...
*/
#define DOUBLE_STEP_DELAY 0//*1 // time in microseconds
...
/** \brief X, Y, Z max acceleration in mm/s^2 for printing moves or retracts. Make sure your printer can go that high!
 Overridden if EEPROM activated.
*/
//#define MAX_ACCELERATION_UNITS_PER_SQ_SECOND_X 1000//*3000
//#define MAX_ACCELERATION_UNITS_PER_SQ_SECOND_Y 1000//*3000
//#define MAX_ACCELERATION_UNITS_PER_SQ_SECOND_Z 1000//*3000

/** \brief X, Y, Z max acceleration in mm/s^2 for travel moves.  Overridden if EEPROM activated.*/
//#define MAX_TRAVEL_ACCELERATION_UNITS_PER_SQ_SECOND_X 1000//*4000
//#define MAX_TRAVEL_ACCELERATION_UNITS_PER_SQ_SECOND_Y 1000//*4000
//#define MAX_TRAVEL_ACCELERATION_UNITS_PER_SQ_SECOND_Z 1000//*4000
...
*/
#define PRINTLINE_CACHE_SIZE 16//*32
...
//#define MIN_EXTRUDER_TEMP 170//*0
...
#define SERVO1_PIN -1//*66
#define SERVO2_PIN -1//*65
#define SERVO3_PIN -1//*64
/* for set servo(s) at designed neutral position at power-up. Values < 500 mean no start position */
#define SERVO0_NEUTRAL_POS  -1//*1300
...
#define Z_PROBE_REPETITIONS 1//5 // Repetitions for probing at one point. 
...
#define Z_PROBE_X1 20//*-69.28
#define Z_PROBE_Y1 20//*-40
#define Z_PROBE_X2 160//*69.28
#define Z_PROBE_Y2 20//*-40
#define Z_PROBE_X3 100//*0
#define Z_PROBE_Y3 160//*80
...
#define FEATURE_BABYSTEPPING 1//*0
...
*/
#define FEATURE_CONTROLLER 0	//CONTROLLER_RADDS	//delta 13
...
// Extreme values
#define UI_SET_MIN_HEATED_BED_TEMP  0//55
//#define UI_SET_MAX_HEATED_BED_TEMP 120
#define UI_SET_MIN_EXTRUDER_TEMP   0//160
