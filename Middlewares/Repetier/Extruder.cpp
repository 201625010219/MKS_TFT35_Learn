...
volatile unsigned int counterPeriodical = 0;
...
volatile uint8 osAnalogInputChannels[9];
volatile uint osAnalogInputValues[9];
void analog_inputs_initial()
{
if ((CfgPrinterItems.cfg_num_extruder > 0) && (CfgPrinterItems.cfg_ext0_tempsensor_type < 101))
{
	Change_Repetier_Define.def_EXT0_ANALOG_INPUTS = 1;
	Change_Repetier_Define.def_EXT0_SENSOR_INDEX = 0;
	Change_Repetier_Define.def_EXT0_ANALOG_CHANNEL = EXT0_TEMPSENSOR_PIN;
}
else
{
	Change_Repetier_Define.def_EXT0_ANALOG_INPUTS = 0;
	Change_Repetier_Define.def_EXT0_SENSOR_INDEX = EXT0_TEMPSENSOR_PIN;
}

if (CfgPrinterItems.cfg_num_extruder > 1 && CfgPrinterItems.cfg_ext1_tempsensor_type < 101)
{
	Change_Repetier_Define.def_EXT1_ANALOG_INPUTS = 1;
	Change_Repetier_Define.def_EXT1_SENSOR_INDEX = Change_Repetier_Define.def_EXT0_ANALOG_INPUTS;
	Change_Repetier_Define.def_EXT1_ANALOG_CHANNEL = EXT1_TEMPSENSOR_PIN;
}
else
{
	Change_Repetier_Define.def_EXT1_ANALOG_INPUTS =0;
	Change_Repetier_Define.def_EXT1_SENSOR_INDEX = EXT1_TEMPSENSOR_PIN;
}

if (CfgPrinterItems.cfg_have_heated_bed && CfgPrinterItems.cfg_heated_bed_sensor_type < 101)
{
	Change_Repetier_Define.def_BED_ANALOG_INPUTS = 1;
	Change_Repetier_Define.def_BED_SENSOR_INDEX = 
		Change_Repetier_Define.def_EXT0_ANALOG_INPUTS
		+Change_Repetier_Define.def_EXT1_ANALOG_INPUTS;
	Change_Repetier_Define.def_BED_ANALOG_CHANNEL = HEATED_BED_SENSOR_PIN;
}
else
{
	Change_Repetier_Define.def_BED_ANALOG_INPUTS = 0;
	Change_Repetier_Define.def_BED_SENSOR_INDEX = HEATED_BED_SENSOR_PIN;
}

#if FAN_THERMO_THERMISTOR_PIN > -1 && FAN_THERMO_PIN > -1
Change_Repetier_Define.def_THERMO_ANALOG_INPUTS =1;
Change_Repetier_Define.def_THERMO_ANALOG_INDEX =
	Change_Repetier_Define.def_EXT0_ANALOG_INPUTS
	+Change_Repetier_Define.def_EXT1_ANALOG_INPUTS
	+Change_Repetier_Define.def_BED_ANALOG_INPUTS;
Change_Repetier_Define.def_THERMO_ANALOG_CHANNEL =FAN_THERMO_THERMISTOR_PIN;

#else
Change_Repetier_Define.def_THERMO_ANALOG_INPUTS =0;
#endif
	
#if defined(ADC_KEYPAD_PIN) && (ADC_KEYPAD_PIN > -1)
	Change_Repetier_Define.def_KEYPAD_ANALOG_INPUTS =1;
	Change_Repetier_Define.def_KEYPAD_ANALOG_INDEX =
		Change_Repetier_Define.def_EXT0_ANALOG_INPUTS
		+Change_Repetier_Define.def_EXT1_ANALOG_INPUTS
		+Change_Repetier_Define.def_BED_ANALOG_INPUTS
		+Change_Repetier_Define.def_THERMO_ANALOG_INPUTS;
	Change_Repetier_Define.def_KEYPAD_ANALOG_CHANNEL = ADC_KEYPAD_PIN;
#else
	Change_Repetier_Define.def_KEYPAD_ANALOG_INPUTS = 0;
#endif

	Change_Repetier_Define.def_ANALOG_INPUTS = 
		 Change_Repetier_Define.def_EXT0_ANALOG_INPUTS
		+Change_Repetier_Define.def_EXT1_ANALOG_INPUTS
		+Change_Repetier_Define.def_EXT2_ANALOG_INPUTS
		+Change_Repetier_Define.def_EXT3_ANALOG_INPUTS
		+Change_Repetier_Define.def_EXT4_ANALOG_INPUTS
		+Change_Repetier_Define.def_EXT5_ANALOG_INPUTS
		+Change_Repetier_Define.def_BED_ANALOG_INPUTS
		+Change_Repetier_Define.def_THERMO_ANALOG_INPUTS
		+Change_Repetier_Define.def_KEYPAD_ANALOG_INPUTS;
		
	uint8_t ext_analog_input = 	 
		Change_Repetier_Define.def_EXT0_ANALOG_INPUTS
		+Change_Repetier_Define.def_EXT1_ANALOG_INPUTS
		+Change_Repetier_Define.def_EXT2_ANALOG_INPUTS
		+Change_Repetier_Define.def_EXT3_ANALOG_INPUTS
	...
	switch(ext_analog_input-1)
	{
	case 5: osAnalogInputChannels[5]=Change_Repetier_Define.def_EXT5_ANALOG_CHANNEL;
	case 4: osAnalogInputChannels[4]=Change_Repetier_Define.def_EXT4_ANALOG_CHANNEL;
	case 3: osAnalogInputChannels[3]=Change_Repetier_Define.def_EXT3_ANALOG_CHANNEL;
	case 2: osAnalogInputChannels[2]=Change_Repetier_Define.def_EXT2_ANALOG_CHANNEL;
	case 1: osAnalogInputChannels[1]=Change_Repetier_Define.def_EXT1_ANALOG_CHANNEL;
	case 0:	 osAnalogInputChannels[0]=Change_Repetier_Define.def_EXT0_ANALOG_CHANNEL;
		break;
	default:break;
	}
	...
	if ((CfgPrinterItems.cfg_have_heated_bed) && (CfgPrinterItems.cfg_heated_bed_sensor_type < 101))
	{
		osAnalogInputChannels[ext_analog_input]=Change_Repetier_Define.def_BED_ANALOG_CHANNEL;	
		#if FAN_THERMO_THERMISTOR_PIN > -1 && FAN_THERMO_PIN > -1
			osAnalogInputChannels[ext_analog_input+1]=Change_Repetier_Define.def_THERMO_ANALOG_CHANNEL;
			#if defined(ADC_KEYPAD_PIN) && (ADC_KEYPAD_PIN > -1)
			osAnalogInputChannels[ext_analog_input+2]=Change_Repetier_Define.def_KEYPAD_ANALOG_CHANNEL;
			#endif
		#else
			#if defined(ADC_KEYPAD_PIN) && (ADC_KEYPAD_PIN > -1)
				osAnalogInputChannels[ext_analog_input+1]=Change_Repetier_Define.def_KEYPAD_ANALOG_CHANNEL;
			#endif
		#endif
	}
	else
	{
		#if FAN_THERMO_THERMISTOR_PIN > -1 && FAN_THERMO_PIN > -1
			osAnalogInputChannels[ext_analog_input]=Change_Repetier_Define.def_THERMO_ANALOG_CHANNEL;
				#if defined(ADC_KEYPAD_PIN) && (ADC_KEYPAD_PIN > -1)
					osAnalogInputChannels[ext_analog_input+1]=Change_Repetier_Define.def_KEYPAD_ANALOG_CHANNEL;
				#endif
			#else
				#if defined(ADC_KEYPAD_PIN) && (ADC_KEYPAD_PIN > -1)
				osAnalogInputChannels[ext_analog_input]=Change_Repetier_Define.def_KEYPAD_ANALOG_CHANNEL;
				#endif
			#endif
	}
...
void Extruder::manageTemperatures()
{
    ...
    for(uint8_t controller = 0; controller < Change_Repetier_Define.def_NUM_TEMPERATURE_LOOPS; controller++)
    {
        ...
        if(act == &thermoController) {
			if(act->currentTemperatureC < Printer::thermoMinTemp)
				pwm_pos[Change_Repetier_Define.def_PWM_FAN_THERMO] = 0;
			else if(act->currentTemperatureC > Printer::thermoMaxTemp)
				pwm_pos[Change_Repetier_Define.def_PWM_FAN_THERMO] = FAN_THERMO_MAX_PWM;
			else {
				...
				if(out > 255)
					...
					pwm_pos[Change_Repetier_Define.def_PWM_FAN_THERMO] = static_cast<uint8_t>(out);
			}
			continue;
		}
#endif
        // Handle automatic cooling of extruders
        if(controller < CfgPrinterItems.cfg_num_extruder)
        {
...
if ((((SHARED_COOLER) && (CfgPrinterItems.cfg_num_extruder >= 2) 
	&& (EXT0_EXTRUDER_COOLER_PIN == EXT1_EXTRUDER_COOLER_PIN)) 
	|| (SHARED_COOLER_BOARD_EXT)) && (EXT0_EXTRUDER_COOLER_PIN > -1))
{
            if(controller == 0)
            {
                bool enable = false;
                for(uint8_t j = 0; j < CfgPrinterItems.cfg_num_extruder; j++)
                {
                ...
                if(pwm_pos[Change_Repetier_Define.def_PWM_BOARD_FAN]) enable = true;
#endif
...
#if MIXING_EXTRUDER
        if(controller > 0 && controller < CfgPrinterItems.cfg_num_extruder) continue; // Mixing extruder only test for ext 0
#endif // MIXING_EXTRUDER
...
//#if HAVE_HEATED_BED
		...
		else if(controller == CfgPrinterItems.cfg_num_extruder && Extruder::getHeatedBedTemperature() > CfgPrinterItems.cfg_heated_bed_maxtemp+ 5) 
		{
...
//#ifdef MAXTEMP
        ...
        if(act->currentTemperatureC > CfgPrinterItems.cfg_ext_maxtemp)
            output = 0;
//#endif // MAXTEMP
    ...
    if(newDefectFound)
    {
        ...
        for(uint8_t i = 0; i < Change_Repetier_Define.def_NUM_TEMPERATURE_LOOPS; i++)
        {
	...
	//tan 20161224
	gCfgItems.temperature_ctrl_err = 1; 	   
    } // any sensor defect
...
void TemperatureController::resetAllErrorStates() {
	...
	for(int i = 0;i < Change_Repetier_Define.def_NUM_TEMPERATURE_LOOPS; i++) {
...
if((EXT0_STEP_PIN > -1)&&(CfgPrinterItems.cfg_num_extruder>0))
{
	...
	WRITE(EXT0_ENABLE2_PIN,!CfgPrinterItems.cfg_e0_enable_on);
	//skyblue-2017-01-04
#endif	
}
//#endif
//#if defined(EXT1_STEP_PIN) && EXT1_STEP_PIN > -1 && NUM_EXTRUDER > 1
	if ((EXT1_STEP_PIN > -1) && (CfgPrinterItems.cfg_num_extruder > 1))
	{
	...
	WRITE(EXT1_ENABLE2_PIN,!CfgPrinterItems.cfg_e1_enable_on);	
	//skyblue-2017-01-04
#endif
	}
//#endif
...
if (CfgPrinterItems.cfg_num_extruder > 5)
{
    ...
    for(i = 0; i < CfgPrinterItems.cfg_num_extruder; ++i)
    {
		...
		//if((Change_Repetier_Define.def_SUPPORT_MAX6675 == 1)||(Change_Repetier_Define.def_SUPPORT_MAX31855==1))
		{
...
if(CfgPrinterItems.cfg_num_extruder>0)
{
    ...
    extruderId = 0;
#endif
    if(extruderId >= CfgPrinterItems.cfg_num_extruder)
        extruderId = 0;
#if !MIXING_EXTRUDER
	Com::printFLN(PSTR("SelectExtruder:"), static_cast<int>(extruderId));
#endif
...
//#ifdef MAXTEMP
    ...
    if(temperatureInCelsius > CfgPrinterItems.cfg_ext_maxtemp) temperatureInCelsius = CfgPrinterItems.cfg_ext_maxtemp;
//#endif
...
//#if HAVE_HEATED_BED
    ...
    if(temperatureInCelsius > CfgPrinterItems.cfg_heated_bed_maxtemp) temperatureInCelsius = CfgPrinterItems.cfg_heated_bed_maxtemp;
    if(temperatureInCelsius < 0) temperatureInCelsius = 0;
    ...
    if(temperatureInCelsius > 15)
        pwm_pos[Change_Repetier_Define.def_PWM_BOARD_FAN] = BOARD_FAN_SPEED;    // turn on the mainboard cooling fan
    else if(Printer::areAllSteppersDisabled())
        pwm_pos[Change_Repetier_Define.def_PWM_BOARD_FAN] = 0;      // turn off the mainboard cooling fan only if steppers disabled
//#endif
		}
...
//#if HAVE_HEATED_BED
	if(CfgPrinterItems.cfg_have_heated_bed == 1)
	{
    	//TemperatureController *c = tempController[NUM_EXTRUDER];
    	TemperatureController *c = tempController[CfgPrinterItems.cfg_num_extruder];
...
if(CfgPrinterItems.cfg_num_extruder > 0)
{
        //WRITE(EXT0_STEP_PIN, START_STEP_WITH_HIGH);   //skyblue  2016-12-15
        E0STEP_OP = START_STEP_WITH_HIGH;
#if defined(EXT0_MIRROR_STEPPER) && EXT0_MIRROR_STEPPER
...
if(CfgPrinterItems.cfg_num_extruder>1)
{
        ...
        E1STEP_OP = START_STEP_WITH_HIGH;
#if defined(EXT1_MIRROR_STEPPER) && EXT1_MIRROR_STEPPER
...
{
    if(dir) {
        //WRITE(EXT0_DIR_PIN,!CfgPrinterItems.cfg_invert_e0_dir);
          E0DIR_OP = !CfgPrinterItems.cfg_invert_e0_dir;
#if defined(EXT0_MIRROR_STEPPER) && EXT0_MIRROR_STEPPER
...
if(CfgPrinterItems.cfg_num_extruder>1)
{
    if(dir) {
        ...
        E1DIR_OP = !CfgPrinterItems.cfg_invert_e1_dir;
#if defined(EXT1_MIRROR_STEPPER) && EXT1_MIRROR_STEPPER
...
{
#if defined(EXT0_ENABLE_PIN) && EXT0_ENABLE_PIN > -1
if(CfgPrinterItems.cfg_num_extruder>0)
{
    //WRITE(EXT0_ENABLE_PIN, EXT0_ENABLE_ON );
    E0ENA_OP = EXT0_ENABLE_ON;
#if defined(EXT0_MIRROR_STEPPER) && EXT0_MIRROR_STEPPER
	//WRITE(EXT0_ENABLE2_PIN, EXT0_ENABLE_ON);
	WRITE(EXT0_ENABLE2_PIN, CfgPrinterItems.cfg_e0_enable_on);
	//skyblue-2017-01-04
...
#endif
#if defined(EXT1_ENABLE_PIN) && EXT1_ENABLE_PIN > -1
if(CfgPrinterItems.cfg_num_extruder>1)
{
    //WRITE(EXT1_ENABLE_PIN, EXT1_ENABLE_ON );
    E1ENA_OP = EXT1_ENABLE_ON;
#if defined(EXT1_MIRROR_STEPPER) && EXT1_MIRROR_STEPPER
	//WRITE(EX10_ENABLE2_PIN, EXT1_ENABLE_ON);
	WRITE(EX10_ENABLE2_PIN, CfgPrinterItems.cfg_e1_enable_on);
	//skyblue-2017-01-04
#endif
}
#endif
#if defined(EXT2_ENABLE_PIN) && EXT2_ENABLE_PIN > -1
if(CfgPrinterItems.cfg_num_extruder>2)
{
...
#endif
#if defined(EXT3_ENABLE_PIN) && EXT3_ENABLE_PIN > -1
	if(CfgPrinterItems.cfg_num_extruder>3)
		{
...
#endif
#if defined(EXT4_ENABLE_PIN) && EXT4_ENABLE_PIN > -1
	if(CfgPrinterItems.cfg_num_extruder>4)
		{
...
#endif
#if defined(EXT5_ENABLE_PIN) && EXT5_ENABLE_PIN > -1
	if(CfgPrinterItems.cfg_num_extruder>5)
		{
...
if(CfgPrinterItems.cfg_num_extruder == 1)
{
    ...
    //WRITE(EXT0_ENABLE_PIN,EXT0_ENABLE_ON );
    E0ENA_OP = CfgPrinterItems.cfg_e0_enable_on;
#if defined(EXT0_MIRROR_STEPPER) && EXT0_MIRROR_STEPPER
	//WRITE(EXT0_ENABLE2_PIN, EXT0_ENABLE_ON);
	//WRITE(EXT0_ENABLE2_PIN, CfgPrinterItems.cfg_e0_enable_on);
	E0ENA2_OP = CfgPrinterItems.cfg_e0_enable_on;
	//skyblue-2017-01-04
#endif
#endif
}
...
void Extruder::disableAllHeater()
{
	...
	{
	    for(uint8_t i = 0; i <= CfgPrinterItems.cfg_num_extruder-1; i++)
	    {
	        TemperatureController *c = tempController[i];
	        c->targetTemperatureC = 0;
	        pwm_pos[c->pwmIndex] = 0;
...
void TemperatureController::autotunePID(float temp,uint8_t controllerId,int maxCycles,bool storeValues)
{
    ...
    if(controllerId<CfgPrinterItems.cfg_num_extruder)
    {
    ...
    for(;;)
    {
        ...
        {
            if(time - t2 > (controllerId < CfgPrinterItems.cfg_num_extruder ? 2500 : 1500))
            {
                heating=false;
        ...
        {
            if(time - t1 > (controllerId < CfgPrinterItems.cfg_num_extruder ? 5000 : 3000))
            {
                heating = true;
                t2 = time;
...
bool reportTempsensorError()
{
    ...
    for(uint8_t i = 0; i < Change_Repetier_Define.def_NUM_TEMPERATURE_LOOPS; i++)
    {
        if(i == CfgPrinterItems.cfg_num_extruder) Com::printF(Com::tHeatedBed);
//#if HAVE_HEATED_BED		
        else if(i == CfgPrinterItems.cfg_num_extruder) 
        {
        if(CfgPrinterItems.cfg_have_heated_bed == 1)
...
int16_t read_max31855(uint8_t ss_pin)
{
    ...
    switch(ss_pin)
    {
    case 1:   MAX31855_T1_CS = 0;  break;
    case 2:   MAX31855_T2_CS = 0;  break;
    default:    break;
    }
    data|=SPI1_ReadWriteByte(0xFF)<<24;  
    data|=SPI1_ReadWriteByte(0xFF)<<16;  
    data|=SPI1_ReadWriteByte(0xFF)<<8;  
    data|=SPI1_ReadWriteByte(0xFF);	 
    switch(ss_pin)
    {
    case 1:   MAX31855_T1_CS = 1;  break;
    case 2:   MAX31855_T2_CS = 1;  break;
    default:    break;
    }
    //Process temp
    if (data & 0x00010000)
...
void Extruder_initArray()
{
	switch((CfgPrinterItems.cfg_num_extruder-1))
	{		
	case 1:
		extruder[1].id = 1;
		extruder[1].xOffset = EXT1_X_OFFSET;
		extruder[1].yOffset = EXT1_Y_OFFSET;
		extruder[1].zOffset = EXT1_Z_OFFSET;
		extruder[1].stepsPerMM = CfgPrinterItems.cfg_ext1_steps_per_mm;;
		extruder[1].enablePin = EXT1_ENABLE_PIN;
		extruder[1].enableOn = CfgPrinterItems.cfg_e1_enable_on;
		extruder[1].maxFeedrate = CfgPrinterItems.cfg_max_feedrate_e1;
		extruder[1].maxAcceleration = CfgPrinterItems.cfg_max_acceleration_e1;
		extruder[1].maxStartFeedrate = EXT1_MAX_START_FEEDRATE;
		extruder[1].extrudePosition = 0;
		extruder[1].watchPeriod = EXT1_WATCHPERIOD;
		extruder[1].waitRetractTemperature = EXT1_WAIT_RETRACT_TEMP;
		extruder[1].waitRetractUnits = EXT1_WAIT_RETRACT_UNITS;
		#if USE_ADVANCE
		#if ENABLE_QUADRATIC_ADVANCE

				extruder[1].advanceK = EXT1_ADVANCE_K;
		#endif
			extruder[1].advanceL = EXT1_ADVANCE_L;
			extruder[1].advanceBacklash = EXT1_ADVANCE_BACKLASH_STEPS;
		#endif
		
		#if MIXING_EXTRUDER > 0
			extruder[1].mixingW = 10;
			extruder[1].mixingE = 10;
			for(uint8_t i=0;i<VIRTUAL_EXTRUDER;i++)
			{
				extruder[1].virtualWeights[i] = 10
			}
		#endif
		
		extruder[1].tempControl.pwmIndex = 1;
		extruder[1].tempControl.sensorType = CfgPrinterItems.cfg_ext1_tempsensor_type;
		extruder[1].tempControl.sensorPin = Change_Repetier_Define.def_EXT1_SENSOR_INDEX;
		extruder[1].tempControl.heatManager = EXT1_HEAT_MANAGER;
		extruder[1].tempControl.currentTemperature = 0;
		extruder[1].tempControl.currentTemperatureC = 0;
		extruder[1].tempControl.targetTemperatureC = 0;
		extruder[1].tempControl.lastTemperatureUpdate = 0;
		#if TEMP_PID
		extruder[1].tempControl.tempIState = 0;
		extruder[1].tempControl.pidDriveMax = EXT1_PID_INTEGRAL_DRIVE_MAX;
		extruder[1].tempControl.pidDriveMin = EXT1_PID_INTEGRAL_DRIVE_MIN;
		extruder[1].tempControl.pidPGain = EXT1_PID_PGAIN_OR_DEAD_TIME;
		extruder[1].tempControl.pidIGain = EXT1_PID_I;
		extruder[1].tempControl.pidDGain = EXT1_PID_D;
		extruder[1].tempControl.pidMax = EXT1_PID_MAX;
		extruder[1].tempControl.tempIStateLimitMax = 0;
		extruder[1].tempControl.tempIStateLimitMin = 0;
		extruder[1].tempControl.tempPointer = 0;
		for(uint8_t i=0;i<4;i++)
		{
			extruder[1].tempControl.tempArray[i] = 0;
		}
		extruder[1].tempControl.flags = 0;
		extruder[1].tempControl.lastDecoupleTest = 0;
		extruder[1].tempControl.lastDecoupleTemp = 0;
		extruder[1].tempControl.decoupleTestPeriod = EXT1_DECOUPLE_TEST_PERIOD;
		#endif
		extruder[1].selectCommands = "";//ext1_select_cmd;
		extruder[1].deselectCommands = "";//ext1_deselect_cmd;
		extruder[1].coolerSpeed = EXT1_EXTRUDER_COOLER_SPEED;
		extruder[1].coolerPWM = 0;
		extruder[1].diameter = 0;
		extruder[1].flags = 0;

		#if EXTRUDER_JAM_CONTROL
		extruder[1].jamStepsSinceLastSignal = 0;
		extruder[1].jamLastSignal = 0;
		extruder[1].jamLastDir = 10;
		extruder[1].jamStepsOnSignal = 0;
		extruder[1].jamLastChangeAt = 0;
		#endif

	case 0:
		extruder[0].id = 0;
		extruder[0].xOffset = EXT0_X_OFFSET;
		extruder[0].yOffset = EXT0_Y_OFFSET;
		extruder[0].zOffset = EXT0_Z_OFFSET;
		extruder[0].stepsPerMM = CfgPrinterItems.cfg_ext0_steps_per_mm;
		extruder[0].enablePin = EXT0_ENABLE_PIN;
		extruder[0].enableOn = CfgPrinterItems.cfg_e0_enable_on;
		extruder[0].maxFeedrate = CfgPrinterItems.cfg_max_feedrate_e0;
		extruder[0].maxAcceleration = CfgPrinterItems.cfg_max_acceleration_e0;
		extruder[0].maxStartFeedrate = EXT0_MAX_START_FEEDRATE;
		extruder[0].extrudePosition = 0;
		extruder[0].watchPeriod = EXT0_WATCHPERIOD;
		extruder[0].waitRetractTemperature = EXT0_WAIT_RETRACT_TEMP;
		extruder[0].waitRetractUnits = EXT0_WAIT_RETRACT_UNITS;
		
		#if USE_ADVANCE
		#if ENABLE_QUADRATIC_ADVANCE
			extruder[0].advanceK = EXT0_ADVANCE_K;
		#endif
			extruder[0].advanceL = EXT0_ADVANCE_L;
			extruder[0].advanceBacklash = EXT0_ADVANCE_BACKLASH_STEPS;
		#endif
		
		#if MIXING_EXTRUDER > 0
		
			extruder[0].mixingW = 10;
			extruder[0].mixingE = 10;
			for(uint8_t i=0;i<VIRTUAL_EXTRUDER;i++)
			{
				extruder[0].virtualWeights[i] = 10
			}
		#endif
		
		extruder[0].tempControl.pwmIndex = 0;
		extruder[0].tempControl.sensorType = CfgPrinterItems.cfg_ext0_tempsensor_type;
		extruder[0].tempControl.sensorPin = Change_Repetier_Define.def_EXT0_SENSOR_INDEX;
		extruder[0].tempControl.heatManager = EXT0_HEAT_MANAGER;
		extruder[0].tempControl.currentTemperature = 0;
		extruder[0].tempControl.currentTemperatureC = 0;
		extruder[0].tempControl.targetTemperatureC = 0;
		extruder[0].tempControl.lastTemperatureUpdate = 0;
		
		#if TEMP_PID
		extruder[0].tempControl.tempIState = 0;
		extruder[0].tempControl.pidDriveMax = EXT0_PID_INTEGRAL_DRIVE_MAX;
		extruder[0].tempControl.pidDriveMin = EXT0_PID_INTEGRAL_DRIVE_MIN;
		extruder[0].tempControl.pidPGain = EXT0_PID_PGAIN_OR_DEAD_TIME;
		extruder[0].tempControl.pidIGain = EXT0_PID_I;
		extruder[0].tempControl.pidDGain = EXT0_PID_D;
		extruder[0].tempControl.pidMax = EXT0_PID_MAX;
		extruder[0].tempControl.tempIStateLimitMax = 0;
		extruder[0].tempControl.tempIStateLimitMin = 0;
		extruder[0].tempControl.tempPointer = 0;
		for(uint8_t i=0;i<4;i++)
		{
			extruder[0].tempControl.tempArray[i] = 0;
		}
		extruder[0].tempControl.flags = 0;
		extruder[0].tempControl.lastDecoupleTest = 0;
		extruder[0].tempControl.lastDecoupleTemp = 0;
		extruder[0].tempControl.decoupleTestPeriod = EXT0_DECOUPLE_TEST_PERIOD;
		#endif
		
		extruder[0].selectCommands = "";//ext0_select_cmd;
		extruder[0].deselectCommands = "";//ext0_deselect_cmd;
		extruder[0].coolerSpeed = EXT0_EXTRUDER_COOLER_SPEED;
		extruder[0].coolerPWM = 0;
		extruder[0].diameter = 0;
		extruder[0].flags = 0;

		#if EXTRUDER_JAM_CONTROL
		extruder[0].jamStepsSinceLastSignal = 0;
		extruder[0].jamLastSignal = 0;
		extruder[0].jamLastDir = 10;
		extruder[0].jamStepsOnSignal = 0;
		extruder[0].jamLastChangeAt = 0;
		#endif
...
if(CfgPrinterItems.cfg_have_heated_bed == 1)
{
	heatedBedController.pwmIndex = CfgPrinterItems.cfg_num_extruder;
	heatedBedController.sensorType = CfgPrinterItems.cfg_heated_bed_sensor_type;
	heatedBedController.sensorPin = Change_Repetier_Define.def_BED_SENSOR_INDEX;
	heatedBedController.heatManager = HEATED_BED_HEAT_MANAGER;
	heatedBedController.currentTemperature = 0;
	heatedBedController.currentTemperatureC = 0;
	heatedBedController.targetTemperatureC = 0;
	heatedBedController.lastTemperatureUpdate = 0;
#if TEMP_PID
	heatedBedController.tempIState = 0;
	...
	heatedBedController.tempIStateLimitMax = 0;
	heatedBedController.tempIStateLimitMin = 0;
	heatedBedController.tempPointer = 0;
	for(uint8_t i= 0;i<4;i++)
	{
		heatedBedController.tempArray[i] = 0;
	}
#endif
	heatedBedController.flags =0;
	heatedBedController.lastDecoupleTest = 0;
	heatedBedController.lastDecoupleTemp = 0;
	heatedBedController.decoupleTestPeriod = HEATED_BED_DECOUPLE_TEST_PERIOD;
}

#if NUM_TEMPERATURE_LOOPS > 0

switch(CfgPrinterItems.cfg_num_extruder)
{
	case 6:
		tempController[5] = &extruder[5].tempControl;
	case 5:
		tempController[4] = &extruder[4].tempControl;
	case 4:
		tempController[3] = &extruder[3].tempControl;
	case 3:
		tempController[2] = &extruder[2].tempControl;
	case 2:
		tempController[1] = &extruder[1].tempControl;
	case 1:
		tempController[0] = &extruder[0].tempControl;
		break;
	default:break;
}
...
{
if (CfgPrinterItems.cfg_num_extruder == 0)
   tempController[0] = &heatedBedController;
else
{
   tempController[CfgPrinterItems.cfg_num_extruder] = &heatedBedController;
}
}
//#endif
#if FAN_THERMO_PIN > -1
...
if(CfgPrinterItems.cfg_have_heated_bed != 1)
{
	tempController[0] = &thermoController;
}
else
{
	tempController[0] = &thermoController;
...
{
if(CfgPrinterItems.cfg_have_heated_bed != 1)
	tempController[CfgPrinterItems.cfg_num_extruder] = &thermoController;
else
	tempController[CfgPrinterItems.cfg_num_extruder+1] = &thermoController;
}
...
#if FAN_THERMO_PIN > -1
TemperatureController thermoController = {Change_Repetier_Define.def_PWM_FAN_THERMO,FAN_THERMO_THERMISTOR_TYPE,THERMO_ANALOG_INDEX,0,0,0,0,0
	#if TEMP_PID
