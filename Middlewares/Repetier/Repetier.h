...
/*---------------skyblue define---------------------*/
#define SD_PAUSE_BIT 1
#define SD_CONTINUE_BIT 2
#define SD_STOP_BIT 4

#define	PRINTER_PAUSE_REPRINT  0xa7		//暂停续打
#define	PRINTER_PWRDN_REPRINT  0xa8		//断电续打
#define	PRINTER_NORMAL         0xa9 	       	//无续打

#define SAVE_CURFILENAME_LEN    32              //保存文件名的最大长度
#define PAUSE_Z_RETRACT      10                 //暂停时 Z轴上升高度

#define SDPOS_BUF_LEN   20       //delta 6; Cartesian 18
//#define FAST_PAUSE      1


#define	MKS_PR_IDLE         0		  //打印机空闲		
#define	MKS_PR_WORKING      1            //打印机忙			
#define	MKS_PR_PAUSE	    2		//打印机暂停
#define	MKS_PR_STOP	    3    	//打印机停止
#define	MKS_PR_REPRINT	    4		//暂停续打或断电续打

/*---------------skyblue define---------------------*/



#define CARTESIAN 100
#define XY_GANTRY 1
#define YX_GANTRY 2
#define DELTA 3
#define TUGA 4
...
//#define ROD_RADIUS (Change_Repetier_Define.def_PRINTER_RADIUS-Change_Repetier_Define.def_END_EFFECTOR_HORIZONTAL_OFFSET-Change_Repetier_Define.def_CARRIAGE_HORIZONTAL_OFFSET)
//#endif
...
public:
    ...
    static inline unsigned long sqr(unsigned long a)
    {
        return a*a;
    }
...
extern volatile uint8 osAnalogInputChannels[9];
...
extern volatile uint osAnalogInputValues[9];
//#endif
...
extern uint8_t pwm_pos[11]; // 0-NUM_EXTRUDER = Heater 0-NUM_EXTRUDER of extruder, NUM_EXTRUDER = Heated bed, NUM_EXTRUDER+1 Board fan, NUM_EXTRUDER+2 = Fan
#if USE_ADVANCE
...
extern volatile unsigned int counterPeriodical;
