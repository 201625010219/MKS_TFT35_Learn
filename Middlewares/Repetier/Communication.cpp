...
#endif // FIRMWARE_URL
FSTRINGVALUE(Com::tFirmware,"FIRMWARE_NAME:Repetier_" REPETIER_VERSION " FIRMWARE_URL:" FIRMWARE_URL " PROTOCOL_VERSION:1.0 MACHINE_TYPE:" MACHINE_TYPE " EXTRUDER_COUNT:" XSTR(CfgPrinterItems.cfg_num_extruder) " REPETIER_PROTOCOL:3")
*/
FSTRINGVALUE(Com::tFirmware,"FIRMWARE_NAME:Robin")
...
FSTRINGVALUE(Com::tStart,"mksRobinPro running...")
...
FSTRINGVALUE(Com::tInvalidDeltaCoordinate_tuga,"Invalid coordinate - move ignored")
FSTRINGVALUE(Com::tDBGDeltaNoMoveinDSegment_tuga,"No move in delta segment with > 1 segment. This should never happen and may cause a problem!")
//#elif DRIVE_SYSTEM == DELTA
FSTRINGVALUE(Com::tInvalidDeltaCoordinate_delta,"Invalid delta coordinate - move ignored")
FSTRINGVALUE(Com::tDBGDeltaNoMoveinDSegment_delta,"No move in delta segment with > 1 segment. This should never happen and may cause a problem!")
//#else
...
//#if DRIVE_SYSTEM==TUGA
FSTRINGVALUE(Com::tEPRDiagonalRodLength_tuga,"Long arm length [mm]")
//#endif // DRIVE_SYSTEM
#ifdef DEBUG_GENERIC
...
//#endif
//#if DRIVE_SYSTEM==DELTA
FSTRINGVALUE(Com::tEPRZAcceleration_delta,"Acceleration [mm/s^2]")
FSTRINGVALUE(Com::tEPRZTravelAcceleration_delta,"Travel acceleration [mm/s^2]")
FSTRINGVALUE(Com::tEPRZStepsPerMM_delta,"Steps per mm")
FSTRINGVALUE(Com::tEPRZMaxFeedrate_delta,"Max. feedrate [mm/s]")
FSTRINGVALUE(Com::tEPRZHomingFeedrate_delta,"Homing feedrate [mm/s]")

FSTRINGVALUE(Com::tEPRDiagonalRodLength_delta,"Diagonal rod length [mm]")
FSTRINGVALUE(Com::tEPRHorizontalRadius_delta,"Horizontal rod radius at 0,0 [mm]")

FSTRINGVALUE(Com::tEPRTowerXOffset_delta,"Tower X endstop offset [steps]")
FSTRINGVALUE(Com::tEPRTowerYOffset_delta,"Tower Y endstop offset [steps]")
FSTRINGVALUE(Com::tEPRTowerZOffset_delta,"Tower Z endstop offset [steps]")

FSTRINGVALUE(Com::tEPRDeltaMaxRadius_delta,"Max printable radius [mm]")
