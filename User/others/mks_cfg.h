...
typedef struct
{
	...
	//	
	volatile int32_t background_color; //è????ˉé￠?è‰2
	volatile int32_t title_color; //???é￠?é￠?è‰2
	volatile int32_t state_background_color; //????�?????¤oè????ˉé￠?è‰?
	volatile int32_t state_text_color; //????�?????¤o?–??-—é￠?è‰2é￠?è‰?
	volatile int32_t filename_color; //?–????????–??-—é￠?è‰?
	volatile int32_t filename_background_color; //?–???????è????ˉé￠?è‰?
