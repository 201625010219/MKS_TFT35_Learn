...
//    machine_menu.marlin=FIRMWARE_TYPE_MARLIN_T_CN;
//    machine_menu.repetier=FIRMWARE_TYPE_REPETIER_T_CN;
//    machine_menu.smoothie=FIRMWARE_TYPE_SMOOTHIE_T_CN;

    machine_menu.BaudRateConfTitle = MACHINE_BAUDRATE_CONFIG_T_CN;
//    machine_menu.rate1=BAUD_RATE_9600_T_CN;
//    machine_menu.rate2=BAUD_RATE_57600_T_CN;
//    machine_menu.rate3=BAUD_RATE_115200_T_CN;
//	machine_menu.rate4=BAUD_RATE_250000_T_CN;
